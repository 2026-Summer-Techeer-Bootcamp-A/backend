const apis = [
    // A. Basic
    { group: 'A. Basic & Auth', method: 'POST', path: '/api/v1/auth/signup', body: { email: "test@example.com", password: "password", nickname: "tester" } },
    { group: 'A. Basic & Auth', method: 'POST', path: '/api/v1/auth/login', body: { email: "test@example.com", password: "password" } },
    { group: 'A. Basic & Auth', method: 'POST', path: '/api/v1/auth/logout' },
    { group: 'A. Basic & Auth', method: 'GET', path: '/api/v1/auth/me' },
    { group: 'A. Basic & Auth', method: 'POST', path: '/api/v1/resume/parse', isMultipart: true },
    { group: 'A. Basic & Auth', method: 'POST', path: '/api/v1/resume/confirm', body: { skills: [{canonical: "Python", category: "language"}], pool: "global" } },
    { group: 'A. Basic & Auth', method: 'POST', path: '/api/v1/resume', body: { title: "My Resume", skills: [], position: "backend", career_min: 3, career_max: 5, pool: "global" } },
    { group: 'A. Basic & Auth', method: 'GET', path: '/api/v1/resume' },
    { group: 'A. Basic & Auth', method: 'GET', path: '/api/v1/resume/{id}', pathParams: ['id'] },
    { group: 'A. Basic & Auth', method: 'PUT', path: '/api/v1/resume/{id}', pathParams: ['id'], body: { title: "Updated" } },
    { group: 'A. Basic & Auth', method: 'DELETE', path: '/api/v1/resume/{id}', pathParams: ['id'] },
    { group: 'A. Basic & Auth', method: 'GET', path: '/api/v1/healthz' },
    
    // B. Analysis
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/match/coverage', queryParams: ['resume_id', 'pool', 'position', 'top_k'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/match/gap', queryParams: ['session_id', 'pool', 'position'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/match/what-if', queryParams: ['resume_id', 'pool', 'add'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/stats/skills', queryParams: ['pool', 'position', 'limit'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/stats/cooccurrence', queryParams: ['skill', 'pool', 'limit'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/stats/industry', queryParams: ['pool', 'industries', 'limit'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/stats/trend', queryParams: ['skill', 'pool', 'interval'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/cert/gap', queryParams: ['resume_id', 'pool', 'position'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/company/by-skill', queryParams: ['skill', 'pool'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/postings', queryParams: ['pool', 'position', 'sort', 'match_only', 'resume_id', 'page'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/postings/map', queryParams: ['region', 'bbox'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/trend/rising', queryParams: ['skills'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/postings/{id}', pathParams: ['id'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/postings/{id}/similar', pathParams: ['id'], queryParams: ['limit'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/postings/{id}/analysis', pathParams: ['id'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/skills', queryParams: ['q', 'category', 'limit'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/job-categories' },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/industries', queryParams: ['pool'] },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/certs', queryParams: ['q'] },
    { group: 'B. Analysis', method: 'POST', path: '/api/v1/resume/feedback', body: { session_id: "xyz", position: "backend" } },
    { group: 'B. Analysis', method: 'GET', path: '/api/v1/news' },
    { group: 'B. Analysis', method: 'POST', path: '/api/v1/chat', body: { message: "Hello", pool: "global" } },
    
    // C. Admin
    { group: 'C. Admin', method: 'GET', path: '/api/v1/admin/collector/status' },
    { group: 'C. Admin', method: 'POST', path: '/api/v1/admin/collector/run', body: { source: "himalayas" } }
];
